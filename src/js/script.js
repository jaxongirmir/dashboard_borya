...
function initAnimations() {
  ...
  const animatedElements = document.querySelectorAll('.service, .service-item, .loan-type, .contact-item, .team-member');
...
function calculateLoan() {
  ...
  resultElement.innerHTML = `
    <div>Ежемесячный платеж: <strong>${monthlyPayment.toFixed(2)} ₽</strong></div>
